...
// import { CategoryAPI } from "../api/categoryApi"; // ✅ updated
...
//     setCategories(res); // backend returns pure array
//   };
...
//                 <tr>
//                   <th className="text-left p-5 font-semibold text-gray-700">Name</th>
//                   <th className="text-left p-5 font-semibold text-gray-700">Description</th>
//                   <th className="text-left p-5 font-semibold text-gray-700">Actions</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {filtered.map((cat) => (
//                   <tr key={cat.categoryId} className="border-b border-gray-100 hover:bg-gray-50 transition">
//                     <td className="p-5 font-medium text-gray-900">{cat.name}</td>
...
//                           className="text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg flex items-center gap-1.5 font-medium transition"
//                         >
//                           <Edit size={17} />
//                           Edit
//                         </button>
...
//                           className="text-red-600 hover:bg-red-50 px-3 py-2 rounded-lg flex items-center gap-1.5 font-medium transition"
//                         >
//                           <Trash2 size={17} />
//                           Delete
//                         </button>
